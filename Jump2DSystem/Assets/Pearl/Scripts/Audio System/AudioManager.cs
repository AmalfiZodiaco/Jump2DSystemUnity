...
namespace Pearl.Audio
{
    ...
    /// </summary>
    public class AudioManager : LogicalManager, ISingleton
    {
        ...
        private readonly List<AudioContainer> activeContainers = new List<AudioContainer>();
        #endregion
        ...
        private AudioContainer auxContainer;
        #endregion
        ...
        {
            listComponents.Add(typeof(ListAudioContainer), new ListAudioContainer());
        }
        #endregion
