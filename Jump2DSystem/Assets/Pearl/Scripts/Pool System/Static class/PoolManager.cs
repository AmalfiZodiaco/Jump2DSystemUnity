...
namespace Pearl.Pools
{
    ...
    public static class PoolManager
    {
        ...
        /// </summary>
        private readonly static Dictionary<string, SpecificPoolManager> listPool;
        #endregion

        #region Constructors
        static PoolManager()
        {
            listPool = new Dictionary<string, SpecificPoolManager>();
        }
        #endregion
        ...
        {
            UnityEngine.Debug.Assert(prefab != null);
        ...
        {
            UnityEngine.Debug.Assert(max >= 0 && obj != null);
