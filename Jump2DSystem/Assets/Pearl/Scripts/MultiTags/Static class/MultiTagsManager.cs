...
namespace Pearl.Multitags
{
    ...
    public static class MultiTagsManager
    {
        ...
        private readonly static List<GameObject> auxListGameObject;
        ...
        {
            UnityEngine.Debug.Assert(tagsParameter != null && tagsParameter.Length != 0);
        ...
        {
            UnityEngine.Debug.Assert(value != null && tagsParameter != null);
        ...
        {
            UnityEngine.Debug.Assert(tags != null && tagsParameter != null);
